...
import com.capgemini.microservices.admin.repository.AccountRepository;
import com.capgemini.microservices.admin.repository.HistoryRepository;
import com.capgemini.microservices.admin.repository.UserRepository;
...
*/
	...
	@Override
	public List<UsersAccount> getAllAccountUsers() {
    List<UsersAccount> accountList=accountRepository.findAll();      
		return accountList;
	}

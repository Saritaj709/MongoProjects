package com.capgemini.microservices.payment.utility;
...
import com.capgemini.microservices.user.model.CreateAccountDTO;
...
public class UserUtility {
	...
	public static void validateUser(CreateAccountDTO user) throws RegistrationException {
